...
# 部署监控对象
object=nginx
object_versions=("1.25.1" "1.24" "1.23" "1.22" "1.21" "1.20" "1.19" "1.18" "1.17" "1.16" "1.14" "1.12")
...
for version in "${object_versions[@]}"; do
    ...
    helm install $object-$version_suffix --namespace $object --create-namespace -f ./values/$value_file ./$object \
